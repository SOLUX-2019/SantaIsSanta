...
let ProviderRatingComponent = class ProviderRatingComponent {
...
ProviderRatingComponent.ctorParameters = () => [
    { type: ProvidersService },
    { type: HttpClient },
    { type: MatSnackBar },
    { type: Router },
...
let ProviderRatingItemComponent = class ProviderRatingItemComponent {
    constructor() {
        this.moment = moment;
    }
    ngOnInit() {
...
let ProviderDetailsComponent = class ProviderDetailsComponent {
    constructor(http) {
        this.http = http;
        this.loading = false;
    }
...
ProviderDetailsComponent.ctorParameters = () => [
    { type: HttpClient }
];
__decorate([
    Input()
